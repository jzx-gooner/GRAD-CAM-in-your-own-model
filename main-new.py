#coding=utf-8
from new_model import blade_model
...
flags = tf.app.flags
flags.DEFINE_string("input", "3.JPG", "Path to input image ['laska.png']")
flags.DEFINE_string("output", "3.png", "Path to input image ['laska_save.png']")
flags.DEFINE_string("layer_name", "layer5-pool2", "Layer till which to backpropagate ['pool5']")
